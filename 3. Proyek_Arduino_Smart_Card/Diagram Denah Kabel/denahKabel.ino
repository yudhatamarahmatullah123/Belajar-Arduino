...
//const char* wifiName = "SAINTEK AREA";
//const char* wifiPass = "gosaintek";

//const char* wifiName = "wifi-premium";
//const char* wifiPass = "tanyasayyidul";

const char* wifiName = "CLOSED";
const char* wifiPass = "123Cl0sed321";

//const char* wifiName = "Lab Komputasi Dasar";
//const char* wifiPass = "AKREDITASI2022";

const String iddev = "98";

String hostMode = "http://absensi.xyz/api/getmodejson?key=mrRkmgf82kjrJNkVYjsfnxz&iddev=" + iddev;
String hostSCAN = "http://172.20.20.7:3015/rfid/";
String hostADD = "http://172.20.20.7:3015/rfid/";
...
void setup() {
  ...
  Wire.begin(5, 4);   //Setting wire (5 untuk SDA dan 4 untuk SCL)
   //rtc.begin();
   //rtc.adjust(DateTime(F(DATE),F(TIME)));  //Setting Time
...
void ModeDevice(){
  ...
  http.begin(wifiClient, hostMode);
