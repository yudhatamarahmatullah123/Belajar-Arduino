...
//Network SSID
const char* ssid     = "PPTIK";
const char* password = "office2022";

//pengenal host (server) = IP Address komputer server
//const char* host = "192.10.17.81";
const char* host = "192.10.10.69";
...
void loop() {
  ...
  if(digitalRead(BTN_PIN)==1)   //ditekan
  {
     ...
     HTTPClient http ;
     //Get Data
     Link = "http://192.10.10.69/absensi/ubahmode.php";
  ...
  String Link;
  HTTPClient http;
  Link = "http://192.10.10.69/absensi/kirimkartu.php?nokartu=" + IDTAG;
  http.begin(wifiClient, Link);
